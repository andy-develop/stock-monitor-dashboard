...
async function buildCsi1000Window() {
    const code = 'SH512100';
    const name = '中证1000ETF华泰柏瑞';
    const indexName = '中证1000指数 (CSI 1000)';
...
async function buildSinopecWindow() {
    const code = 'SH600028';
    const name = '中国石化';
...
async function buildMideaWindow() {
    const code = 'SZ000333';
    const name = '美的集团';
    const indexName = '家用电器 · 深证成指成份';
...
async function buildZijinWindow() {
    const code = 'SH601899';
    const name = '紫金矿业';
    const indexName = '有色金属 · 黄金矿业龙头';
    ...
    try {
        ...
        saveLastRun({
            ...
            windows: [
                ...
                { id: zijinWindow.id, stockCode: zijinWindow.stockCode, buyAlerts: zijinWindow.buyAlerts, sellAlert: zijinWindow.sellAlert },
            ],
        });
